    ...
    <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
      <div className="relative flex h-16 items-center justify-between">
        ...
        <div className="absolute inset-y-0 right-0 flex gap-3 items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
          ...
          {!isAuthenticated ?
            <button onClick={() => loginWithRedirect()} className='text-white bg-green-700 px-6 py-1 rounded-sm'>Login</button>
            :
            <div className="relative ml-3">
              ...
              {isOpen && (
                <div onMouseLeave={() => setIsOpen(false)} className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                  <a
                    href="#"
